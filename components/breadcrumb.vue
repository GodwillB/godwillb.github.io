<template>
    <nav class="flex items-center pb-20 justify-center" aria-label="Progress">
      <p class="text-sm font-medium">Page {{ steps.findIndex((step) => step.status === 'current') + 1 }} of {{ steps.length }}</p>
